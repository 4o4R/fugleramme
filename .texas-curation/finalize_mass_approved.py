...
ATTRIBUTIONS = {
    ...
    "bailey-village-field": "**Bailey (village and field)** - *Birds of Village and Field* by **Florence Merriam Bailey**, from the public-domain Biodiversity Heritage Library scan linked through Wikimedia Commons. Manifest key: `bailey-village-field`.",
    "leverian-museum": "**Leverian Museum** - plates from *Musei Leveriani explicatio, anglica et latina* by **George Shaw**, with illustrations by artists including **Sarah Stone**, **Sydenham Edwards**, **Philip Reinagle**, and **Charles R. Ryley**, from public-domain Biodiversity Heritage Library / Smithsonian Libraries scans on Wikimedia Commons. Exact file pages are linked in the manifest. Manifest key: `leverian-museum`.",
